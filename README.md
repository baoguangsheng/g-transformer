...
(Notes: Our models were trained on 4 GPUs. If you run them on 2 GPUs, in theory you could double the number for argument --update-freq. However, we haven't test such settings.)
