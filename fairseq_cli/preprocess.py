#!/usr/bin/env python3
# Changed by Guangsheng Bao, 2020/9/25
#
    ...
    def make_binary_dataset(vocab, input_prefix, output_prefix, lang, num_workers):
        ...
        merge_result(
            Binarizer.binarize(
                ...
                offset=0, end=offsets[1], append_eos=False  # Guangsheng Bao: input file has already appended </s>
            )
        )
        if num_workers > 1:
            pool.join()
...
# Guangsheng Bao: input file has already appended </s>, so set append_eos=False
