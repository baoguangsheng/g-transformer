...
class TransformerEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args, add_global_attn):
        return TransformerEncoderLayer(args, add_global_attn)
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def build_decoder_layer(self, args, no_encoder_attn, dec_add_global_attn, crs_add_global_attn):
        return TransformerDecoderLayer(args, no_encoder_attn, dec_add_global_attn, crs_add_global_attn)
...
@register_model_architecture("transformer", "transformer_doc_big")
def transformer_doc_big(args):
    args.encoder_layers = getattr(args, "encoder_layers", 6)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 16)
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 1024)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 4096)
...
@register_model_architecture("transformer", "transformer_doc_large")
def transformer_doc_large(args):
