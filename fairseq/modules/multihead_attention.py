...
# copy from torch.nn.functional.py, update the attention mask logic
def multi_head_attention_forward(query,                           # type: Tensor
    ...
    if attn_mask is not None:
        ...
        attn_output_weights = attn_output_weights.masked_fill(attn_mask.unsqueeze(1), float("-inf"))
        attn_output_weights = attn_output_weights.view(bsz * num_heads, tgt_len, src_len)
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.qkv_same_dim = self.qdim == embed_dim and self.kdim == embed_dim and self.vdim == embed_dim
        ...
        self.out_proj = quant_noise(nn.Linear(embed_dim, self.odim, bias=bias), q_noise, qn_block_size)
